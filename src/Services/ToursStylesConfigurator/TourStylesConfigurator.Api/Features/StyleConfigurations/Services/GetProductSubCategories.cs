...
public interface IGetProductSubCategoriesQuery
{
    Task<List<SubCategoryDto>> GetAll(string language);
}

public class GetProductSubCategoriesQuery : IGetProductSubCategoriesQuery
{
    ...
    public GetProductSubCategoriesQuery(IExcelDictionaryProvider excelDictionaryProvider,
        IMemoryCache cache, ConfigurationsSettings configurationsSettings)
    {
