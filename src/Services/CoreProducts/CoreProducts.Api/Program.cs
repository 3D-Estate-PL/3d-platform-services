...
using CoreProducts.Api;
using CoreProducts.Infrastructure;
...
builder.Services.AddCoreProductLibrary(builder.Configuration,builder.Environment.EnvironmentName == "dev");
