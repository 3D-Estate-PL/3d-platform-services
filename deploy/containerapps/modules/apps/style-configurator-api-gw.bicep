...
var domainName = {
  'staging': 'configurator-api-stg.3destate.pl'
  'prd': 'configurator-api.3destate.pl'
}[environment]
...
resource containerApp 'Microsoft.App/containerApps@2022-10-01' = {
  name: 'style-configurator-api-gw'
  location: location
  properties: {
    ...
    template: {
      containers: [
        {
          name: 'style-configurator-api-gw'
          image: '${azureContainerRegistry}/style-configurator-api-gw:${imageTag}'
          env: [
            {
    ...
    configuration: {
      ...
      dapr: {
        enabled: true
        appId: 'style-configurator-api-gw'
        appPort: 80
      }
      ingress: {
        external: true
